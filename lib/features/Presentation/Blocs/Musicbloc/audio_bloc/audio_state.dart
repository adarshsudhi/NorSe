...
class AudioState with _$AudioState {
  ...
  const factory AudioState.Localsongs(
      ...
      int index,
      AudioPlayer audioPlayer) = _Localsongs;
  ...
  const factory AudioState.onlinesongs(
      ...
      ValueStream<AudioState> valueStream,
      int index,
      AudioPlayer audioPlayer) = _Onlinesongs;

  const factory AudioState.onlinestreams(Duration pos, Duration dur,
      PlayerState playerState, Duration buffer, int index) = _Onlinestreams;
