...
class YtsearchBloc extends Bloc<YtsearchEvent, YtsearchState> {
  YtsearchBloc() : super( const _Initial()) {
    ...
    on<_Freestate>((event, emit)async{
      ...
      dynamic playlist0 = await di.di<Getplaylistusecase>().call('PLy_wKxVmWb4bHyORGk5KjXKbMwGyg3WA-', 'playlist');
      dynamic playlist2 = await di.di<Getplaylistusecase>().call('PLHuHXHyLu7BHdV9kfWgHYPxwj57C_hSWw', 'playlist');
      dynamic playlist3 = await di.di<Getplaylistusecase>().call('PLvOzZx-CNB835HVZYHCWDd_BCYlOGGf0c', 'playlist');



      emit(YtsearchState.fres(playlist0,playlist1,playlist2,playlist3,false,false));
