                          ...
                          slivers: [
                                  ...
                                  children: [
                                    CachedNetworkImage(
                                      errorWidget: (context, url, error) {
                                        return Thumbnailfuturebuilder(video: songs[0].thumbnails);
                                      },
                            ...
                            SliverPadding(
                              ...
                              sliver: SliverList(
                                ...
                                return InkWell(
                                  onTap: () {
                                       Navigator.pushNamed(context,Testytplayer.testytplayer,arguments: Testytplayer(video: songs, index: index));
                                   },
                                  child: Padding(
                                                ...
                                                mainAxisAlignment: MainAxisAlignment.center,                                             
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: CachedNetworkImage(
                                                              ...
                                                              imageUrl: songs[index].thumbnails.maxResUrl,fit: BoxFit.cover,),
                                                          ),
                                                        ...
                                                        Expanded(
                                                          ...
                                                          children: [
                                                              ...
                                                              Textutil(text: songs[index].author, fontsize: 12, color: Colors.white.withOpacity(0.6), fontWeight: FontWeight.normal)
                                                          ],
                                                          ),
                                                        )
                                                         ],
