...
import 'package:nebula/features/Presentation/Pages/subscreens/SongDetailsPage/SongDetailsPage.dart';
...
class _SongwidgetState extends State<Songwidget> with SingleTickerProviderStateMixin {
  ...
  late AnimationController slidercontroller;
    ...
    super.initState();
     ...
     slidercontroller = AnimationController(vsync: this,duration: const Duration(milliseconds: 1500));

     animations = List.generate(widget.count, (index) => Tween(begin: const Offset(0,1),end: Offset.zero).animate(
      CurvedAnimation(parent: slidercontroller, curve: Interval(index*(1/widget.count),1,curve: Curves.bounceOut))
      ));
