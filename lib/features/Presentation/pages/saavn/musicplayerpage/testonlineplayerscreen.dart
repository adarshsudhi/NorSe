                  ...
                  return StreamBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData && snapshot.data != null) {
                        ...
                        audios.isNotEmpty
                            ? BlocProvider.of<SonglikeBloc>(context).add(
                              ...
                              children: [
                                    ...
                                    IconButton(
                                        onPressed: () {
                                          Navigator.pushNamed(context,
                                              Onlinequeue.onlinequeuescreen,
                                              arguments: Onlinequeue(
                                                audios: audios,
                                ...
                                Row(
                                  ...
                                  children: [
                                    PlayIcons(
                                      iconscolors: islooped == true
                                          ...
                                          : const Color.fromARGB(
                                              255, 68, 68, 68),
                                      iconsize: 25,
                                      playicons: CupertinoIcons.loop_thick,
                                      ontap: () {
                                        setState(() {
                                          islooped = !islooped;
                                        });
                                    ...
                                    PlayIcons(
                                      iconscolors: state.audioPlayer.hasPrevious
                                          ? const Color.fromARGB(
                                              255, 255, 255, 255)
                                ...
                                Row(
                                  ...
                                  children: [
                                    PlayIcons(
                                        ...
                                        ontap: () async {
                                          audios.isNotEmpty
                                              ? _downloadsong(audios, songindex)
                                              : null;
                                        }),
                                    SizedBox(
                                      width: MediaQuery.sizeOf(context).width /
                                    ...
                                    BlocBuilder<SonglikeBloc, SonglikeState>(
                                      builder: (context, state0) {
                                        return state0.maybeWhen(removed: () {
                                          return PlayIcons(
                                              playicons:
                                                ...
                                                AlbumElements song =
                                                    AlbumElements(
                                                        ...
                                                        Artist:
                                                            audios[songindex]
                                                                .artist,
                                                        url: audios[songindex]
                                                            .downloadurl,
                                                        image: audios[songindex]
                                                            .imageurl);
