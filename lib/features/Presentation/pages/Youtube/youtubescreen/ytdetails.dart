                        ...
                        children: [
                            ...
                            child: CachedNetworkImage(
                              errorWidget: (context, url, error) {
                                return Thumbnailfuturebuilder(
                                    video: videoinfo.thumbnails);
                              },
                              imageUrl: videoinfo.thumbnails.maxResUrl,
                              fit: BoxFit.cover,
                            ),
                          ),
                          Spaces.kheight10,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Textutil(
                                  text:
                                      "Audio • ${audionly.bitrate.toString().replaceAll('it', '')} •  ${audionly.audioCodec.split('.')[0]}",
                                  fontsize: 14,
                                  color: Colors.white,
                                  fontWeight: FontWeight.normal),
                            ],
                            ...
                            children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Textutil(
                                                    text:
                                                        "${audionly.audioCodec} • ${audionly.size}",
                                                    fontsize: 10,
                                                    color: Colors.black,
                                                    fontWeight:
                                                        FontWeight.bold),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: Colors.white),
                                child: Center(child: BlocBuilder<YtdownloadBloc,
                                    YtdownloadState>(
                                  builder: (context, state) {
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Textutil(
                                  text:
                                      "Video • ${videos[selectedindex].qualityLabel} • ${videos[0].codec.subtype}",
                                  fontsize: 14,
                                  color: Colors.white,
                                  fontWeight: FontWeight.normal),
                            ],
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Textutil(
                                    text:
                                        'Download video in ${videos[selectedindex].qualityLabel}',
                                    fontsize: 15,
                                    color: Colors.white,
                                    fontWeight: FontWeight.w500),
                                Textutil(
                                    text:
                                        "Size ${videos[selectedindex].size} • Quality ${videos[selectedindex].qualityLabel}",
                                    fontsize: 10,
                                    color: Colors.white,
                                    fontWeight: FontWeight.w500),
                              ],
