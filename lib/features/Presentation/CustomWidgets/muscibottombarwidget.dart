...
class MusicbottombarWidget extends StatelessWidget {
  const MusicbottombarWidget({
    ...
    required this.playerState, required this.type,
  }) : super(key: key);
      ...
      child: Center(
        child: ListTile(
          ...
          subtitle: SizedBox(
            height: 12,
            width: 100,
            child: Textutil(text: audios[songindex].artist, fontsize: 10, color: Colors.white, fontWeight:FontWeight.normal),
          ),
          trailing: SizedBox(
            width: 150,
            child:  Row(
              ...
              children: [
                ...
                }, icon: Icon(CupertinoIcons.backward_end_fill,color:audioPlayer.hasPrevious? Colors.white: Colors.grey,size: 15,)),
                GestureDetector(
                  onTap: () {
                ...
                }, icon: Icon(CupertinoIcons.forward_end_fill,color:audioPlayer.hasNext? Colors.white: Colors.grey,size: 15,))
              ],
            ),
          ),
        ),
